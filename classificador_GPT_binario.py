...
def classificar_comentario(comentario):
    resposta = openai.Completion.create(
        ...
        prompt=f"Classifique o seguinte comentário sobre inteligência artificial como 'p' (positivo) ou 'n' (negativo):\n\n{comentario}\n\nClassificação:",
        temperature=0.0,
        max_tokens=1,
        n=1,
        stop=None,
...
#Remover os comentários classificados manualmente como neutros
...
df.to_csv('comentarios_GPT_binario.csv')
